...
namespace EmbeddedResourceVirtualPathProvider
{
    ...
    //public class SwitchingVirtualPathProvider : VirtualPathProvider
    //{
    //    private readonly IEnumerable<VirtualPathProvider> _virtualPathProviders;

    //    public SwitchingVirtualPathProvider(IEnumerable<VirtualPathProvider> virtualPathProviders)
    //    {
    ...
    //    private Stack<VirtualPathProvider> ProviderStack {
    //        get
    //        {
    //            if (HttpContext.Current.Items["WC-SwitchingVirtualPathProvider"] == null)
    //            {
    //                var stack = new Stack<VirtualPathProvider>();
    //                stack.Push(new DefaultVirtualPathProvider());
    //                HttpContext.Current.Items["WC-SwitchingVirtualPathProvider"] = stack;
    //            }

    //            return (Stack<VirtualPathProvider>)HttpContext.Current.Items["WC-SwitchingVirtualPathProvider"];
    //        }
    //    }

    //    public VirtualPathProvider Current {
    //        get
    //        {
    //            return Previous
    //        }
